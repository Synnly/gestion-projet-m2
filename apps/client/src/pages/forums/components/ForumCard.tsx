...
export function ForumCard({ forum }: Props) {
    return (
        <div className="h-fit card bg-base-100 shadow-sm shadow-base-300 hover:shadow-md hover:bg-base-200 w-full transition-all duration-100 ease-out cursor-pointer">
