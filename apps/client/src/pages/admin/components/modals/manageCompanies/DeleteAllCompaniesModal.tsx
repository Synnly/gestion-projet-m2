...
export const DeleteAllCompaniesModal = ({ onConfirm, onCancel, isLoading = false }: Props) => {
                ...
                <div className="modal-box">
                    <div className="flex justify-between items-center mb-4">
                        <h3 className="font-bold text-lg flex items-center gap-2 text-error">
                            ...
                            Suppression de tous les comptes entreprises
                        </h3>
                    ...
                    <div className="py-4">
                        <p className="alert alert-error text-center text-error-content font-bold mb-4">
                            VOUS ETES SUR LE POINT DE SUPPRIMER TOUS LES COMPTES ENTREPRISES. CETTE ACTION SERA
                            EFFECTIVE DANS 30 JOURS.
                        </p>
                    </div>
