                ...
                <div className="modal-box min-w-200">
                    <div className="flex justify-between items-center mb-4">
                        <h3 className="font-bold text-lg flex items-center gap-2 text-error">
                            ...
                            Suppression des comptes entreprise sélectionnés
                        </h3>
                    ...
                    <div className="py-4">
                        <p className="alert alert-error text-center text-error-content font-bold mb-4">
                            Vous êtes sur le point de supprimer les comptes de {companies.length} entreprises. Cette
                            action sera effective dans 30 jours. Les comptes seront désactivés immédiatement.
                        </p>
