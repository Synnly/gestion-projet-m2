...
export const ApplicationTable = ({ status, title, activeTab, setActiveTab }: Props) => {
    ...
    async function updateApplicationStatus(applicationId: string, newStatus: ApplicationStatus) {
        ...
        try {
            await authFetch(`${API_URL}/api/application/${applicationId}`, {
                method: 'PUT',
                                                    ...
                                                    <td className="whitespace-nowrap text-center">
                                                        <div className="flex gap-1 justify-center">
                                                            {(status === ApplicationStatusEnum.PENDING ||
                                                                status === ApplicationStatusEnum.READ) && (
                                                                <>
                                                                    <button
                    ...
                    <div className="modal modal-open">
                        ...
                        >
                            ...
                            <p className="py-4">
                                ...
                                {confirmModal.newStatus === ApplicationStatusEnum.ACCEPTED ? 'accepter' : 'rejeter'} la
                                candidature de <span className="font-semibold">{confirmModal.studentName}</span> ?
                            </p>
